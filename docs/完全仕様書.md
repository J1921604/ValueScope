...
| 項目 | XBRLタグ | 説明 |
|------|---------|------|
| 平均年間給与 | `jpcrp_cor:AverageAnnualSalaryInformationAboutReportingCompanyInformationAboutEmployees` | 提出会社の従業員情報における平均年間給与（円） |
| 平均勤続年数 | `jpcrp_cor:AverageLengthOfServiceYearsInformationAboutReportingCompanyInformationAboutEmployees` | 提出会社の従業員情報における平均勤続年数（年） |
| 平均年齢 | `jpcrp_cor:AverageAgeYearsInformationAboutReportingCompanyInformationAboutEmployees` | 提出会社の従業員情報における平均年齢（歳） |
| 従業員数 | `jpcrp_cor:NumberOfEmployeesInformationAboutReportingCompanyInformationAboutEmployees` | 提出会社の従業員情報における従業員数（人） |
