...
const fieldLabelMap: Record<string, string> = {
  ...
  : 'その他',
  AllEmployeesDifferencesInWagesBetweenMaleAndFemaleEmployeesMetricsOfConsolidatedSubsidiaries: 'AllEmployeesDifferencesInWagesBetweenMaleAndFemaleEmployeesMetricsOfConsolidatedSubsidiaries',
  AllEmployeesDifferencesInWagesBetweenMaleAndFemaleEmployeesMetricsOfReportingCompany: 'AllEmployeesDifferencesInWagesBetweenMaleAndFemaleEmployeesMetricsOfReportingCompany',
  AllEmployeesRatioOfMaleEmployeesTakingChildcareLeaveMetricsOfConsolidatedSubsidiaries: '～比率',
  ...
  AverageAnnualSalaryInformationAboutReportingCompanyInformationAboutEmployees: 'AverageAnnualSalaryInformationAboutReportingCompanyInformationAboutEmployees',
  ...
  BookValueDetailsOfSpecifiedInvestmentEquitySecuritiesHeldForPurposesOtherThanPureInvestmentLargestHoldingCompany: '帳簿価額',
  BookValueDetailsOfSpecifiedInvestmentEquitySecuritiesHeldForPurposesOtherThanPureInvestmentReportingCompany: '帳簿価額',
  BookValueDetailsOfSpecifiedInvestmentEquitySecuritiesHeldForPurposesOtherThanPureInvestmentSecondLargestHoldingCompany: '帳簿価額',
  BookValueEquitySecuritiesNotListedInvestmentEquitySecuritiesHeldForPureInvestmentLargestHoldingCompany: '帳簿価額',
  BookValueEquitySecuritiesNotListedInvestmentEquitySecuritiesHeldForPurposesOtherThanPureInvestmentLargestHoldingCompany: '帳簿価額',
  BookValueEquitySecuritiesNotListedInvestmentEquitySecuritiesHeldForPurposesOtherThanPureInvestmentReportingCompany: '帳簿価額',
  BookValueEquitySecuritiesOtherThanThoseNotListedInvestmentEquitySecuritiesHeldForPurposesOtherThanPureInvestmentLargestHoldingCompany: '帳簿価額',
  BookValueEquitySecuritiesOtherThanThoseNotListedInvestmentEquitySecuritiesHeldForPurposesOtherThanPureInvestmentReportingCompany: '帳簿価額',
  CapitalStock: '資本金',
  CapitalSurplus: '資本剰余金',
  CarryingAmountSharesNotListedInvestmentSharesHeldForPurposesOtherThanPureInvestmentLargestHoldingCompany: '帳簿価額',
  CarryingAmountSharesNotListedInvestmentSharesHeldForPurposesOtherThanPureInvestmentReportingCompany: '帳簿価額',
  CarryingAmountSharesNotListedInvestmentSharesHeldForPurposesOtherThanPureInvestmentSecondLargestHoldingCompany: '帳簿価額',
  CarryingAmountSharesOtherThanThoseNotListedInvestmentSharesHeldForPurposesOtherThanPureInvestmentLargestHoldingCompany: '帳簿価額',
  CarryingAmountSharesOtherThanThoseNotListedInvestmentSharesHeldForPurposesOtherThanPureInvestmentReportingCompany: '帳簿価額',
  CarryingAmountSharesOtherThanThoseNotListedInvestmentSharesHeldForPurposesOtherThanPureInvestmentSecondLargestHoldingCompany: '帳簿価額',
  CashAndCashEquivalents: '現金及び現金同等物',
  CommercialPapersLiabilities: 'コマーシャルペーパー',
  ComprehensiveIncomeSummaryOfBusinessResults: '包括利益',
  ConstructionAndRetirementInProgressNCAInProcessELE: 'ConstructionAndRetirementInProgressNCAInProcessELE',
  ConstructionInProgressELE: '建設仮勘定',
  ConstructionInProgressNCAInProgressELE: '建設仮勘定',
  ContractAssets: 'ContractAssets',
  ContractLiabilities: 'ContractLiabilities',
  ContributionPayableForNuclearReactorDecommissioningNCLELE: 'ContributionPayableForNuclearReactorDecommissioningNCLELE',
  CumulativeEffectsOfChangesInAccountingPolicies: 'CumulativeEffectsOfChangesInAccountingPolicies',
  CurrentPortionOfNoncurrentLiabilitiesCLELE: '固定負債',
  DeferredGainsOrLossesOnHedges: 'DeferredGainsOrLossesOnHedges',
  DeferredTaxLiabilities: '繰延税金負債',
  DeferredTaxLiabilitiesNCL: '繰延税金負債',
  DepositsReceived: 'DepositsReceived',
  DilutedEarningsPerShareSummaryOfBusinessResults: 'DilutedEarningsPerShareSummaryOfBusinessResults',
  DistributionFacilitiesNCAElectricELE: 'DistributionFacilitiesNCAElectricELE',
  ElectricUtilityOperatingRevenueELE: '電気事業',
  ElectricUtilityPlantAndEquipmentAssetsELE: '電気事業',
  FacilitiesLoanedNCAElectricELE: 'FacilitiesLoanedNCAElectricELE',
  ForeignCurrencyTranslationAdjustment: '為替',
  GeneralFacilitiesNCAElectricELE: 'GeneralFacilitiesNCAElectricELE',
  GeneralReserve: 'GeneralReserve',
  GrantsInAidReceivableFromNuclearDamageCompensationFacilitationCorporationIOAELE: 'GrantsInAidReceivableFromNuclearDamageCompensationFacilitationCorporationIOAELE',
  HydroelectricPowerProductionFacilitiesNCAElectricELE: 'HydroelectricPowerProductionFacilitiesNCAElectricELE',
  IncidentalBusinessFacilitiesELE: 'IncidentalBusinessFacilitiesELE',
  IncreaseOrDecreaseDueToChangesInAccountingTreatmentOfAffiliatedCompaniesAccountedForByTheEquityMethod: 'IncreaseOrDecreaseDueToChangesInAccountingTreatmentOfAffiliatedCompaniesAccountedForByTheEquityMethod',
  InternalCombustionEnginePowerProductionFacilitiesNCAElectricELE: 'InternalCombustionEnginePowerProductionFacilitiesNCAElectricELE',
  InvestmentsAndOtherAssets: 'その他',
  LeaseObligationsNCL: 'LeaseObligationsNCL',
  LegalCapitalSurplus: '資本剰余金',
  LegalRetainedEarnings: '利益剰余金',
  LiabilitiesAndNetAssets: '純資産',
  LoadedNuclearFuelNCAELE: 'LoadedNuclearFuelNCAELE',
  LongTermAccruedLiabilitiesNCLELE: 'LongTermAccruedLiabilitiesNCLELE',
  LongTermDebtToSubsidiariesAndAffiliatesNCLELE: 'LongTermDebtToSubsidiariesAndAffiliatesNCLELE',
  LongTermInvestmentForSubsidiariesAndAffiliatesELE: 'LongTermInvestmentForSubsidiariesAndAffiliatesELE',
  LongTermInvestmentsELE: 'LongTermInvestmentsELE',
  ...
  NonOperatingFacilitiesELE: 'NonOperatingFacilitiesELE',
  NonRegularEmployeesDifferencesInWagesBetweenMaleAndFemaleEmployeesMetricsOfConsolidatedSubsidiaries: 'NonRegularEmployeesDifferencesInWagesBetweenMaleAndFemaleEmployeesMetricsOfConsolidatedSubsidiaries',
  NonRegularEmployeesDifferencesInWagesBetweenMaleAndFemaleEmployeesMetricsOfReportingCompany: 'NonRegularEmployeesDifferencesInWagesBetweenMaleAndFemaleEmployeesMetricsOfReportingCompany',
  NotesAndAccountsPayableTrade: '買掛金',
  NotesAndAccountsReceivableTradeAndContractAssets: '売掛金',
  NotesReceivableTrade: 'NotesReceivableTrade',
  NuclearFuelInProcessingNCAELE: 'NuclearFuelInProcessingNCAELE',
  NuclearFuelNCAELE: 'NuclearFuelNCAELE',
  NuclearPowerAbolitionInProgressELE: '原子力',
  NuclearPowerProductionFacilitiesNCAElectricELE: '原子力',
  NumberOfAssociatesAccountedForUsingEquityMethod: 'NumberOfAssociatesAccountedForUsingEquityMethod',
  NumberOfConsolidatedSubsidiaries: 'NumberOfConsolidatedSubsidiaries',
  NumberOfEmployees: '従業員数',
  NumberOfFemaleDirectorsAndOtherOfficers: 'その他',
  NumberOfFemaleDirectorsAndOtherOfficersProposal: 'その他',
  NumberOfIssuedSharesAsOfFilingDateIssuedSharesTotalNumberOfSharesEtc: '株式数',
  NumberOfIssuedSharesAsOfFiscalYearEndIssuedSharesTotalNumberOfSharesEtc: '株式数',
  NumberOfIssuesSharesNotListedInvestmentSharesHeldForPureInvestmentLargestHoldingCompany: '銘柄数',
  NumberOfIssuesSharesNotListedInvestmentSharesHeldForPurposesOtherThanPureInvestmentLargestHoldingCompany: '銘柄数',
  NumberOfIssuesSharesNotListedInvestmentSharesHeldForPurposesOtherThanPureInvestmentReportingCompany: '銘柄数',
  NumberOfIssuesSharesNotListedInvestmentSharesHeldForPurposesOtherThanPureInvestmentSecondLargestHoldingCompany: '銘柄数',
  NumberOfIssuesSharesOtherThanThoseNotListedInvestmentSharesHeldForPurposesOtherThanPureInvestmentLargestHoldingCompany: '銘柄数',
  NumberOfIssuesSharesOtherThanThoseNotListedInvestmentSharesHeldForPurposesOtherThanPureInvestmentReportingCompany: '銘柄数',
  NumberOfIssuesSharesOtherThanThoseNotListedInvestmentSharesHeldForPurposesOtherThanPureInvestmentSecondLargestHoldingCompany: '銘柄数',
  NumberOfMaleDirectorsAndOtherOfficers: 'その他',
  NumberOfMaleDirectorsAndOtherOfficersProposal: 'その他',
  NumberOfNamesOfSecuritiesEquitySecuritiesNotListedInvestmentEquitySecuritiesHeldForPurposesOtherThanPureInvestmentLargestHoldingCompany: '株式',
  NumberOfNamesOfSecuritiesEquitySecuritiesNotListedInvestmentEquitySecuritiesHeldForPurposesOtherThanPureInvestmentReportingCompany: '株式',
  NumberOfNamesOfSecuritiesEquitySecuritiesOtherThanThoseNotListedInvestmentEquitySecuritiesHeldForPurposesOtherThanPureInvestmentLargestHoldingCompany: '株式',
  NumberOfNamesOfSecuritiesEquitySecuritiesOtherThanThoseNotListedInvestmentEquitySecuritiesHeldForPurposesOtherThanPureInvestmentReportingCompany: '株式',
  NumberOfNamesOfSecuritiesWhoseNumberOfSharesDecreasedEquitySecuritiesNotListedInvestmentEquitySecuritiesHeldForPurposesOtherThanPureInvestmentLargestHoldingCompany: '株式',
  NumberOfNamesOfSecuritiesWhoseNumberOfSharesDecreasedEquitySecuritiesNotListedInvestmentEquitySecuritiesHeldForPurposesOtherThanPureInvestmentReportingCompany: '株式',
  NumberOfNamesOfSecuritiesWhoseNumberOfSharesIncreasedEquitySecuritiesNotListedInvestmentEquitySecuritiesHeldForPurposesOtherThanPureInvestmentLargestHoldingCompany: '株式',
  NumberOfShareholdersFinancialInstitutions: '株主',
  NumberOfShareholdersFinancialServiceProviders: '株主',
  NumberOfShareholdersForeignIndividualInvestors: '株主',
  NumberOfShareholdersForeignInvestorsOtherThanIndividuals: 'その他',
  NumberOfShareholdersIndividualsAndOthers: 'その他',
  NumberOfShareholdersNationalAndLocalGovernments: '株主',
  NumberOfShareholdersOtherCorporations: 'その他',
  NumberOfShareholdersTotal: '株主',
  NumberOfSharesConstitutingOneUnit: '株式数',
  NumberOfSharesHeld: '株式数',
  NumberOfSharesHeldDetailsOfSpecifiedInvestmentEquitySecuritiesHeldForPurposesOtherThanPureInvestmentLargestHoldingCompany: '株式',
  NumberOfSharesHeldDetailsOfSpecifiedInvestmentEquitySecuritiesHeldForPurposesOtherThanPureInvestmentReportingCompany: '株式',
  NumberOfSharesHeldDetailsOfSpecifiedInvestmentEquitySecuritiesHeldForPurposesOtherThanPureInvestmentSecondLargestHoldingCompany: '株式',
  NumberOfSharesHeldInOwnNameTreasurySharesEtc: '株式数',
  NumberOfSharesHeldNumberOfUnitsFinancialInstitutions: '株式数',
  NumberOfSharesHeldNumberOfUnitsFinancialServiceProviders: '株式数',
  NumberOfSharesHeldNumberOfUnitsForeignIndividualInvestors: '株式数',
  NumberOfSharesHeldNumberOfUnitsForeignInvestorsOtherThanIndividuals: '株式数',
  NumberOfSharesHeldNumberOfUnitsIndividualsAndOthers: '株式数',
  NumberOfSharesHeldNumberOfUnitsNationalAndLocalGovernments: '株式数',
  NumberOfSharesHeldNumberOfUnitsOtherCorporations: '株式数',
  NumberOfSharesHeldNumberOfUnitsTotal: '株式数',
  NumberOfSharesHeldOrdinarySharesInformationAboutDirectorsAndCorporateAuditors: '株式数',
  NumberOfSharesHeldOrdinarySharesInformationAboutDirectorsAndCorporateAuditorsProposal: '株式数',
  NumberOfSharesHeldOrdinarySharesInformationAboutExecutiveDirectors: '株式数',
  NumberOfSharesHeldOrdinarySharesInformationAboutExecutiveDirectorsProposal: '株式数',
  NumberOfSharesHeldSharesLessThanOneUnit: '株式数',
  NumberOfSharesIssuedSharesVotingRights: '株式数',
  NumberOfSubmissionDEI: 'NumberOfSubmissionDEI',
  NumberOfUnconsolidatedSubsidiariesAndAssociatesAccountedForUsingEquityMethod: 'NumberOfUnconsolidatedSubsidiariesAndAssociatesAccountedForUsingEquityMethod',
  NumberOfVotingRightsHeld: 'NumberOfVotingRightsHeld',
  NumberOfVotingRightsIssuedSharesVotingRights: 'NumberOfVotingRightsIssuedSharesVotingRights',
  OperatingExpensesELE: '営業費用',
  OperatingRevenueELE: '営業収益',
  OrdinaryIncomeLossSummaryOfBusinessResults: '経常利益',
  OtherAccountsReceivableCAELE: 'その他',
  OtherAdvancesCLELE: 'その他',
  OtherBusinessOperatingRevenueELE: '営業収益',
  OtherCA: 'その他',
  OtherCL: 'その他',
  OtherCapitalSurplus: '資本剰余金',
  OtherCurrentAssetsCAELE: '流動資産',
  OtherCurrentLiabilitiesCLELE: '流動負債',
  OtherElectricUtilityPlantAndEquipmentNCAElectricELE: '電気事業',
  OtherIOA: 'その他',
  OtherNCL: 'その他',
  OtherNoncurrentAssetsELE: '固定資産',
  OtherNoncurrentLiabilitiesNCLELE: '固定負債',
  OtherRetainedEarnings: 'その他',
  PercentageOfShareholdingsFinancialInstitutions: 'PercentageOfShareholdingsFinancialInstitutions',
  PercentageOfShareholdingsFinancialServiceProviders: 'PercentageOfShareholdingsFinancialServiceProviders',
  PercentageOfShareholdingsForeignIndividuals: 'PercentageOfShareholdingsForeignIndividuals',
  PercentageOfShareholdingsForeignersOtherThanIndividuals: 'その他',
  PercentageOfShareholdingsIndividualsAndOthers: 'その他',
  PercentageOfShareholdingsNationalAndLocalGovernments: 'PercentageOfShareholdingsNationalAndLocalGovernments',
  PercentageOfShareholdingsOtherCorporations: 'その他',
  PreferredStockClassATotalNumberOfIssuedSharesSummaryOfBusinessResult: 'PreferredStockClassATotalNumberOfIssuedSharesSummaryOfBusinessResult',
  PreferredStockClassBTotalNumberOfIssuedSharesSummaryOfBusinessResults: 'PreferredStockClassBTotalNumberOfIssuedSharesSummaryOfBusinessResults',
  PrepaidExpenses: 'PrepaidExpenses',
  PrepaidPensionCostIOA: 'PrepaidPensionCostIOA',
  PriceEarningsRatioSummaryOfBusinessResults: 'PriceEarningsRatioSummaryOfBusinessResults',
  ProfitLossAttributableToOwnersOfParentSummaryOfBusinessResults: 'ProfitLossAttributableToOwnersOfParentSummaryOfBusinessResults',
  ...
  RateOfReturnOnEquitySummaryOfBusinessResults: 'RateOfReturnOnEquitySummaryOfBusinessResults',
  ...
  RawMaterialsAndSupplies: 'RawMaterialsAndSupplies',
  RegularEmployeesDifferencesInWagesBetweenMaleAndFemaleEmployeesMetricsOfConsolidatedSubsidiaries: 'RegularEmployeesDifferencesInWagesBetweenMaleAndFemaleEmployeesMetricsOfConsolidatedSubsidiaries',
  RegularEmployeesDifferencesInWagesBetweenMaleAndFemaleEmployeesMetricsOfReportingCompany: 'RegularEmployeesDifferencesInWagesBetweenMaleAndFemaleEmployeesMetricsOfReportingCompany',
  RemeasurementsOfDefinedBenefitPlans: 'RemeasurementsOfDefinedBenefitPlans',
  RenewablePowerProductionFacilitiesNCAElectricELE: 'RenewablePowerProductionFacilitiesNCAElectricELE',
  ReserveForFluctuationInWaterLevelsReservesUnderTheSpecialLawsELE: 'ReserveForFluctuationInWaterLevelsReservesUnderTheSpecialLawsELE',
  ReserveForOverseasInvestmentLoss: 'ReserveForOverseasInvestmentLoss',
  ReserveForPreparationOfTheDepreciationOfNuclearPowerConstructionReservesUnderTheSpecialLawsELE: '減価償却費',
  ReserveForSpecialDisasterELE: 'ReserveForSpecialDisasterELE',
  ReserveFundForNuclearReactorDecommissioningIOAELE: 'ReserveFundForNuclearReactorDecommissioningIOAELE',
  ReserveFundForReprocessingOfIrradiatedNuclearFuelIOAELE: 'ReserveFundForReprocessingOfIrradiatedNuclearFuelIOAELE',
  ReservesUnderTheSpecialLaws2: 'ReservesUnderTheSpecialLaws2',
  RestatedBalance: 'RestatedBalance',
  RetainedEarningsBroughtForward: '利益剰余金',
  RetirementInProgressNCAInProgressELE: 'RetirementInProgressNCAInProgressELE',
  RevaluationReserveForLand: '土地',
  SecurityCodeDEI: 'SecurityCodeDEI',
  ShareholdersEquity: '株主',
  ShareholdingRatio: 'ShareholdingRatio',
  ShareholdingRatioTreasurySharesEtc: 'ShareholdingRatioTreasurySharesEtc',
  ShortTermDebtToSubsidiariesAndAffiliatesCLELE: '短期',
  ShortTermReceivablesFromSubsidiariesAndAffiliatesCAELE: '短期',
  SpecialAccountRelatedToReprocessingOfSpentNuclearFuelELE: 'SpecialAccountRelatedToReprocessingOfSpentNuclearFuelELE',
  SubscriptionRightsToShares: 'SubscriptionRightsToShares',
  Supplies: 'Supplies',
  ThermalPowerProductionFacilitiesNCAElectricELE: 'ThermalPowerProductionFacilitiesNCAElectricELE',
  TotalNumberOfIssuedSharesSummaryOfBusinessResults: 'TotalNumberOfIssuedSharesSummaryOfBusinessResults',
  TotalNumberOfSharesHeldTreasurySharesEtc: '株式数',
  TotalReturnOnSharePriceIndex: 'TotalReturnOnSharePriceIndex',
